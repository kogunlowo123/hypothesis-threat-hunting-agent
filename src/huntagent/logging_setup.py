...
def configure_logging(level: str = "INFO", *, json_output: bool = True) -> None:
    """Configure the ``huntagent`` logger tree.
...
def get_logger(name: str) -> logging.Logger:
    """Return a logger namespaced under ``huntagent``."""
    return logging.getLogger(name if name.startswith("huntagent") else f"huntagent.{name}")
